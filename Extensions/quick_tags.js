...
XKit.extensions.quick_tags = new Object({
	...
	button_icon: 'data:image/svg+xml,%3Csvg viewBox="0 0 20 20" height="20" width="20" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="m1.3 1.3v7.8l11 9.8 6.9-7.8-9.8-9.8z" fill="none" stroke="%237b7b7b" stroke-linejoin="round" stroke-width="1.9"/%3E%3Ccircle cx="4.8" cy="4.8" fill="%237b7b7b" r="1.6"/%3E%3C/svg%3E',
	button_ok_icon: 'data:image/svg+xml,%3Csvg viewBox="0 0 20 20" height="20" width="20" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="m1.3 1.3v7.8l11 9.8 6.9-7.8-9.8-9.8z" fill="none" stroke="%236BA52A" stroke-linejoin="round" stroke-width="1.9"/%3E%3Ccircle cx="4.8" cy="4.8" fill="%236BA52A" r="1.6"/%3E%3C/svg%3E',
	preferences: {
		"sep0": {
			text: "Options",
			type: "separator"
